...
declare class LilypadCache<K extends LilypadCacheKey, V> {
     ...
     */
    protected emitInvalidation(source: LilypadInvalidationEvent['source'], keys: K[]): void;
    /**
...
export { LilypadCache, LilypadCacheCooldownError, type LilypadCacheGetOptions, type LilypadCacheKey, type LilypadCacheOptions, type LilypadCacheResult, type LilypadCacheSharedOptions, type LilypadCacheStatus, type LilypadCachedValueType, type LilypadSharedCodec };
