...
const require_LilypadSingleton = require("./LilypadSingleton-B2cch1Oh.cjs");
...
var LilypadLogger = class LilypadLogger {
	...
	*/
	static create(options) {
		return require_LilypadSingleton.createLilypadSingletonAble("LilypadLogger", options, () => new LilypadLogger(options), {
	...
	constructor(options) {
		...
		for (const type of Object.keys(this.components)) {
			...
			const logFn = (...message) => {
				...
				require_LilypadPlatform.runInBackground(options.platform, task, () => {});
				return task;
			};
			this[type] = logFn;
		}
...
//#endregion
Object.defineProperty(exports, "LILYPAD_DEFAULT_REDACTED_KEYS", {
	enumerable: true,
	get: function() {
		return LILYPAD_DEFAULT_REDACTED_KEYS;
	}
});
Object.defineProperty(exports, "LilypadConsoleLogger", {
	enumerable: true,
	get: function() {
		return LilypadConsoleLogger;
	}
});
Object.defineProperty(exports, "LilypadDiscordLogger", {
	enumerable: true,
	get: function() {
		return LilypadDiscordLogger;
	}
});
Object.defineProperty(exports, "LilypadJsonConsoleLogger", {
	enumerable: true,
	get: function() {
		return LilypadJsonConsoleLogger;
	}
});
Object.defineProperty(exports, "LilypadLogger", {
	enumerable: true,
	get: function() {
		return LilypadLogger;
	}
});
Object.defineProperty(exports, "LilypadLoggerComponent", {
	enumerable: true,
	get: function() {
		return LilypadLoggerComponent;
	}
});

//# sourceMappingURL=logger-X-jbKNMG.cjs.map