...
var LilypadCache = (_class = class {
  ...
  errorReturn(error, options, key) {
    ...
    this.setLocal(key, valueToReturn, _nullishCoalesce(options.errorTtl, () => ( this.defaultErrorTtl)));
...
//# sourceMappingURL=chunk-7QJ33PAP.js.map