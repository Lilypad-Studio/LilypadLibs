...
var _chunkGTX3YQ2Sjs = require('./chunk-GTX3YQ2S.js');
...
var LilypadDbCache = (_class2 = class _LilypadDbCache extends _chunkGTX3YQ2Sjs.LilypadCache_default {
  
  
  
  /** Whether the default listener updates the cache (not only a callback of the application). */
  __init3() {this.listenAppliesChanges = false}
   ...
   */
  __init4() {this.members = /* @__PURE__ */ new Map()}
   ...
   * reflected in it.
   */
  __init6() {this.ownWrites = /* @__PURE__ */ new Map()}
  // Changelog strategy state
  
  /** Changes already applied, by id, with their transaction id, until the cursor passes them. */
  __init7() {this.appliedChanges = /* @__PURE__ */ new Map()}
  __init8() {this.lastChangelogRead = 0}
  ...
  constructor(ttl, options) {
    var _a;
    super(ttl, { ...options, name: _nullishCoalesce(options.name, () => ( options.dbGate.schema.tableName)) });_class2.prototype.__init3.call(this);_class2.prototype.__init4.call(this);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);_class2.prototype.__init7.call(this);_class2.prototype.__init8.call(this);;
  ...
  resolveNotifiedKey(id) {
    ...
    return _nullishCoalesce(_nullishCoalesce(((_a = this.store.get(normalizedKey)) == null ? void 0 : _a.key), () => ( ((_b = this.members.get(normalizedKey)) == null ? void 0 : _b.key))), () => ( id));
  }
  /**
...
//# sourceMappingURL=chunk-67IDI7L6.js.map