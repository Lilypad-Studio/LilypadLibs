...
declare class LilypadCache<K extends LilypadCacheKey, V> {
    ...
    private refreshing;
    constructor(ttl?: number, options?: LilypadCacheOptions<K, V>);
    /**
     ...
     */
    protected setIfNewer(key: K, value: LilypadCachedValueType<V>, ttl: number | undefined, ticket: number, fetchedAt?: number): boolean;
    /**
     ...
     * @returns `true` if the value was stored.
     */
    protected storeFetched(key: K, value: LilypadCachedValueType<V>, ttl: number | undefined, ticket: number, fetchedAt: number): boolean;
    /**
...
export { LilypadCache as L, LilypadCacheCooldownError as a, type LilypadCacheGetOptions as b, type LilypadCachedValueType as c, type LilypadCacheKey as d, type LilypadCacheOptions as e, type LilypadCacheResult as f, type LilypadCacheSharedOptions as g, type LilypadCacheStatus as h, type LilypadSharedCodec as i, type LilypadCacheEntry as j };
